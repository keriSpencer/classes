...
// make (Mazda), location (USA), airbags (true), abs (true), warranty (60,000 miles / 3 years)
...
// OPTIONS", i.e: "Building one red Sport Mazda3 with the following options: heated seats, rear spoiler"
...
class Factory {
  ...
  // with the following options: weather package, satellite radio, rear spoiler"
...
// let factory = new Factory(mazda3)
// console.log(Factory.massBuild(5, mazda3))
// console.log(factory)

// CREATE A SUB-CLASS CALLED CAR
// It should extend from Factory.
// The constructor should have the following properties:
//   model, doors, color, enginetype, transmission, trim, wheelstrim, audio, seatstrim, moonroof.
...
// Car should also have the following additional properties:
//   enginesize (4), navigation (true), backupcamera (true), warranty (100,000 miles / 5 years)
...
// Sports cars should also have the following additional properties:
//   moonroof (false), enginetype (gasoline), convertible (true), doors (2)
// Write your code below:
...
// It should extend from 'Factory'.
// The constructor should have the following properties:
//   model, color, enginesize, hitch, bed, navigation. The values should be specified when creating an instance of Truck.
...
// The following properties must be specified: model (mazda3), color (red),
// enginetype (hybrid), transmission (automatic), trim (touring), wheels (base),
// audio (premium), seats (leather), and moonroof (true)

// Write your 'mazda3' instance below:
let mazda3 = new Car('Mazda3', 2, 'red', 'gasoline', 'automatic', 'Touring', 'silver', 'basic', 'leather', true)
console.log(mazda3)
...
// Write your code below:let factory = new Factory(mazda3)
console.log(Factory.massBuild(35000, mazda3))
...
// Write your code below:
mazda3.options = ['weather', ' satellite radio', ' rear spoiler']
mazda3.color = 'yellow'

console.log(Factory.customerBuild('yellow', mazda3))
...
console.log(Sport.massBuild(15000, miataRf))
miataRf.options = [
  'hid headlights',
  ' sports suspension',
...
// Print miataRf, calling customerBuild(), building one black Miata-Rf with the following options,
// as an array: hid headlights, sports suspension, leather steering wheel, heated seats, adaptive cruise control.
// It should read: "Building one black Grand Touring Miata-RF with the following options:
//   hid headlights, sports suspension, leather steering wheel, heated seats, adaptive cruise control"
// Write your code below:
console.log(Sport.customerBuild('black', miataRf))

// TRAIL BLAZER MASS PRODUCTION
// The Trail Blazer should inherit from truck.
// The following properties must be specified: model (Trail Blazer), color (blue),
//   trim (Sport), enginesize (8), hitch (true), bed (standard), navigation (true), doors (2)

let trailBlazer = new Truck('Trail Blazer', 'blue', 8, 'Sport', true, 'standard', true, 'x')
console.log(trailBlazer.doors)
...
console.log(Truck.massBuild(3500, trailBlazer))

trailBlazer.options = ['seat warmers', ' tinted windows', ' fog lamps']
...
// It should print: "Building one red Sport Trail Blazer with the
// following options: seat warmers, tinted windows, fog lamps"
// Write your code below:
console.log(Truck.customerBuild('red', trailBlazer))
